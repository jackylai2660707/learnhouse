export const queryKeys = {
  ...
  assignments: {
    ...
    remediation: (uuid: string) => ['assignment', uuid, 'remediation', 'me'] as const,
    ...
    workbench: (orgId: number) => ['assignments', orgId, 'workbench'] as const,
    operationsSummary: (orgId: number, filters?: string) => ['assignments', orgId, 'operations-summary', filters ?? ''] as const,
    gradebookAll: (orgId: number) => ['assignments', orgId, 'gradebook'] as const,
    gradebook: (orgId: number, filters?: string) => ['assignments', orgId, 'gradebook', filters ?? ''] as const,
    gradebookSummary: (orgId: number, filters?: string) => ['assignments', orgId, 'gradebook-summary', filters ?? ''] as const,
    allCourseAssignments: () => ['assignments-all'] as const,
    studentQueue: (orgId: number) => ['student-home-assignment-queue', orgId] as const,
  },
  usergroups: {
  ...
  ai: {
    assignmentGenerationStatus: () => ['ai', 'assignments', 'status'] as const,
    ragSessions: (orgSlug: string) => ['ai', 'rag', 'sessions', orgSlug] as const,
    pdfBuilds: (orgId: number) => ['ai', 'courseplanning', 'pdf-builds', orgId] as const,
    pdfBuild: (orgId: number, jobUuid: string) => ['ai', 'courseplanning', 'pdf-builds', orgId, jobUuid] as const,
  },
  selfTests: {
    me: (orgId: number) => ['self-tests-me', orgId] as const,
    org: (orgId: number) => ['self-tests-org', orgId] as const,
    studentHome: (orgId: number) => ['student-home-self-tests', orgId] as const,
  },
  questionBank: {
    categories: (orgId: number) => ['question-bank-categories', orgId] as const,
    items: (orgId: number) => ['question-bank-items', orgId] as const,
    itemsSearch: (orgId: number, filters?: string) => ['question-bank-items', orgId, filters ?? ''] as const,
    selfTestReadiness: (orgId: number) => ['question-bank-items', orgId, 'self-test-readiness', 'ORG'] as const,
  },
  certifications: {
